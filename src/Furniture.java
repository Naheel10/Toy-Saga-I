...
/**
 * This class contains the code that represents a piece of Clothing for use in the 
 * Wardrobe Manager project.
 */
public class Clothing {
    ...
    /**
     * This is a constructor that creates a new clothing object with the given description and
     * brand.
     * 
    ...
    /**
     * This method updates the number of times this piece of clothing has been worn and the last worn date
    ...
    public String toString() {
      ...
      if (lastWornDate != null) {
          dateStr = lastWornDate.getMonthValue() + "/" + lastWornDate.getDayOfMonth() + "/" + lastWornDate.getYear();
      } else {
          dateStr = "null";
      }
      return description + "," + brand + "," + dateStr + "," + timesWorn;
  }
